...
- Asset bundles go into the `BepInEx/plugins/[a folder you need to make]/LegacyVirtualObjects/` folder (this was changed as of [Otherloader 0.3.1](https://github.com/devyndamonster/OtherLoader/releases/tag/v0.3.1))
